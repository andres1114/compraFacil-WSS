...
db_connection_mysql = db_connection.createDbConnection(db_type='mysql', db_host='192.168.10.14', db_user='root', db_pass='admin', db_name='compraFacil')
...
if len(queryData[0]) > 0:
    ...
    for x in range(len(queryData[0])):
        ...
        if isProcessruning:
            ...
            shell_command = "cd " + current_dir_path + "/" + spiders_directory_name + "/" + spider_name + "/; scrapy crawl " + spider_name + " -a log_output=" + logOutputArg + " >/dev/null 2>&1"
